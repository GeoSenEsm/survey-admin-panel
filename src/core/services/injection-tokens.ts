...
import { LOCATION_SERVICE, RESEARCH_AREA_SERVICE, SENSOR_DATA_SERVICE, SENSOR_PROFILE_SERVICE, SENSORS_SERVICE, START_SURVEY_SERVICE, STORAGE_SERVICE, SURVEY_SETTINGS_SERVICE, TOKEN_HANDLER } from "./registration-names";
...
export const START_SURVEY_SERVICE_TOKEN: InjectionToken<StartSurveyService>
 ...
 export const SENSOR_DATA_SERVICE_TOKEN = new InjectionToken<SensorDataService>(SENSOR_DATA_SERVICE);
